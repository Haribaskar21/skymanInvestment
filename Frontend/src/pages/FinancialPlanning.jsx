  ...
  return (
    <div className="py-12 px-4 md:px-20">
      {sections.map((section, index) => (
        <div
          key={index}
          className="mb-10 p-6 rounded-2xl border border-blue-200 bg-white shadow-sm"
        ...
        >
          ...
          {section.button && (
            <a
              ...
              className="inline-block mt-6 px-6 py-2 text-white bg-green-600 hover:bg-green-700 rounded-full shadow"
            >
