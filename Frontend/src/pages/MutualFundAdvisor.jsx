...
const MutualFundAdvisor = () => {
  ...
  return (
    <div className="text-[#1C3C6D] py-10 px-4 bg-white">
      ...
      >
        <h1
          className="text-4xl md:text-5xl font-extrabold text-[#1C3C6D]"
          data-aos="fade-down"
        >
      ...
      <div className="max-w-6xl mx-auto rounded-2xl shadow-lg overflow-hidden p-6 md:p-10 border border-[#1C3C6D]/20">
        <div className="grid md:grid-cols-3 gap-8 mb-10" data-aos="fade-up">
          ...
          <div className="md:col-span-2">
            <motion.h1
              className="text-3xl font-bold text-[#1C3C6D] mb-2"
              initial={{ opacity: 0, x: -30 }}
              animate={{ opacity: 1, x: 0 }}
            >
              Meet Rajesh Krishnamoorthy
            </motion.h1>
            <p className="text-sm text-[#1C3C6D]/70 mb-4">
              Advisor Code: <strong>ARN-177405</strong>
            </p>
            <p className="text-lg leading-relaxed">
              Welcome to my website! I’m <strong>Rajesh Krishnamoorthy</strong>, a dedicated mutual fund advisor with over{" "}
              <strong>25 years</strong> of experience helping individuals and families invest wisely. My mission is to empower you to achieve your financial goals through personalized mutual fund strategies.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-10">
          ...
          <Section
            ...
            items={[
              {
                title: "Mutual Fund Investment Advisory",
                text: "Tailored fund recommendations matching your financial goals.",
              },
              {
                title: "Portfolio Management",
                text: "Ongoing optimization of your portfolio for best performance.",
              },
              {
                title: "Retirement Planning",
                text: "Structured plans to build your retirement corpus via mutual funds.",
              },
              {
                title: "Tax-efficient Investment Strategies",
                text: "Minimize taxes while maximizing returns.",
              },
              {
                title: "Systematic Investment Plans (SIPs)",
                text: "Grow wealth through disciplined monthly investments.",
              },
            ]}
          />
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl font-bold text-[#26BF64] mb-4">
              Let’s Get Started
            </h2>
            <p className="text-lg mb-6 max-w-2xl mx-auto text-[#1C3C6D]/90 leading-relaxed">
            ...
            <a
              href="#"
              className="inline-block bg-[#26BF64] hover:bg-[#219f55] text-white px-6 py-3 rounded-lg font-medium transition-all"
            >
...
const Section = ({ title, items, singleColumn }) => (
  <div data-aos="fade-up">
    <h3 className="text-xl md:text-2xl font-semibold text-[#1C3C6D] mb-4">{title}</h3>
    <div className={`grid ${singleColumn ? "grid-cols-1" : "md:grid-cols-2"} gap-6`}>
      {items.map((item, i) => (
        <div
          key={i}
          className="bg-[#E6F4EA] p-4 rounded-xl border border-[#26BF64]/30 shadow-sm"
        >
          {item.title && (
            <h4 className="font-bold text-[#1C3C6D] mb-1">{item.title}</h4>
          )}
          <p>{item.text}</p>
        </div>
      ))}
