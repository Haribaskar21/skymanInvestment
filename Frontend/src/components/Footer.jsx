        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div data-aos="fade-up" data-aos-delay="400">
            ...
            <ul className="flex flex-wrap gap-6 text-sm items-center">
              {[
                { href: "https://www.linkedin.com/in/iamrk/", label: "LinkedIn", icon: "assets/linkedin.png", color: "hover:text-blue-700" },
                { href: "https://x.com/rajeshkmoorthy", label: "X", icon: "assets/x.png", color: "assets/hover:text-blue-400" },
                { href: "https://www.facebook.com/skyman.rajesh", label: "Facebook", icon: "assets/facebook.png", color: "hover:text-blue-600" },
                { href: "https://www.instagram.com/skymaninvestments/", label: "Instagram", icon: "assets/instagram.png", color: "hover:text-pink-500" },
                { href: "https://www.threads.com/@skymaninvestments", label: "Threads", icon: "assets/threads.png", color: "hover:text-black" }
              ].map((item, idx) => (
